...
public class Usuario extends JFrame {
	...
	public Usuario() {
		...
		super("Cadastro de Usuario"); // utiliza construtor da super classe
										// JFrame
		setLayout(new FlowLayout()); // Configura o layout do frame (ainda nÃ£o
		...
		profissao = new JTextField("\tProfissão", 20);
		profissao.setFont(FonteItalico);
		profissao.setToolTipText("Insira aqui sua profissão");
		add(profissao);
...
//				determina o item selecionado
		...
		campoSenha = new JLabel("    Confirmaçao Senha:   ");
		add(campoSenha);
