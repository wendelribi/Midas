		...
		<c:forEach items="${mammogramId}" var="mammogramId">
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					...
					<h3>Mamograma Visitado: ${mammogramId}</h3>
				</div>
			</div>
		</c:forEach>
...
<%
	if (request.getAttribute("mammogramVazio") != null
			&& request.getAttribute("mammogramVazio").equals("true")) {
%>
<div class="alert alert-info" role="alert">Sem historico para
	mostrar</div>
<%
	}
%>